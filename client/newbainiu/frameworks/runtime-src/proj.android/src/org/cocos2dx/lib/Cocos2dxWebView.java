...
public class Cocos2dxWebView extends WebView {
	...
	public Cocos2dxWebView(Context context, int viewTag) {
		...
		LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, (int) getResources().getDimension(R.dimen.back_left), 0);
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				((Cocos2dxActivity) Cocos2dxActivity.getContext()).runOnGLThread(new Runnable() {
					@Override
					public void run() {
						int id = Cocos2dxLuaJavaBridge.callLuaGlobalFunctionWithString("onWebViewFinish", "");
